...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Des 2022 pada 05.30
...
(1, 'admin', '$2y$10$fetknyRWIpyGMC5NhLh5OOFsJM39k3r5LY.RJp6vCFjvnjpBh5992', 'Dealer yamaha', '081222333444', 'https://yamaha.com', '-', NULL, 'super_user', NULL, NULL, 1671186587, '::1', 1, 0, 1556509343, 1661633811, NULL, 1, 1, NULL),
...
--
ALTER TABLE `detail_order`
  MODIFY `iddetail_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `user_profile`
  MODIFY `idUser_profile` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
