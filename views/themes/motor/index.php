...
<head>
    <title>Dealer Resmi Motor Juara</title>
    <meta charset="utf-8">
...
<body class="goto-here">
                    ...
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <a href="tel:<?=settings('company_profile','phone');?>"><span
                                    class="text">081380917584</span></a>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span
                                    class="icon-paper-plane"></span></div>
                            <a href="mailto:<?=settings('company_profile','email');?>"><span
                                    class="text">juaramotor66@gmail.com</span></a>
                        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="#">Dealer Resmi Motor Juara</a>
