...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url(); ?>"><b>Dealer Motor Juara</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Silahkan Isi Data Dibawah !</p>
            ...
            Sudah Punya Akun ?<a href="<?=base_url('auth');?>" class="text-center"> Login </a>
            <br>
